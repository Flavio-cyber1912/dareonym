...
// Variabile per indicare che l'obbligo è stato inserito correttamente
$obbligoAggiornato = false;

// Verifica se il form è stato inviato e le variabili sono state inizializzate
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["save_changes"]) && isset($_POST['description_obbligation']) && isset($_POST['data_creation_obbligation'])) {
    // Assegna i valori delle variabili
    $description_obbligation = $_POST['description_obbligation'];
    $data_creation_obbligation = $_POST['data_creation_obbligation'];

    // Genera un ID univoco per id_obbligation utilizzando il timestamp attuale
    $id_obbligation = time();

    // Verifica se l'obbligo con lo stesso ID esiste già nel database
    $sql_check_existence = "SELECT id_obbligation FROM dr_obbligation WHERE id_obbligation = $id_obbligation";
    $stmt_check_existence = $db->query($sql_check_existence);

    if ($stmt_check_existence->rowCount() == 0) {
        // Se l'obbligo non esiste già nel database, esegui l'inserimento
        $sql = "INSERT INTO dr_obbligation (id_obbligation, creator_id, description_obbligation, data_creation_obbligation, state_obbligation, point_obbligation) 
                VALUES (:id_obbligation, NULL, :description_obbligation, :data_creation_obbligation, NULL, NULL)";

        // Esegui la query per l'inserimento dell'obbligo
        try {
            $stmt = $db->prepare($sql);
            $stmt->execute(array(':id_obbligation' => $id_obbligation, ':description_obbligation' => $description_obbligation, ':data_creation_obbligation' => $data_creation_obbligation));
            echo "Nuovo obbligo inserito con successo";

            // Imposta la variabile per indicare che l'obbligo è stato inserito correttamente
            $obbligoAggiornato = true;

            // Rimuovi il flag per consentire l'invio del form di nuovo
            unset($_SESSION['form_submitted']);

            // Ottieni tutti gli ID degli obblighi inseriti durante questa operazione
            $obblighi_inseriti = array();
            $sql_get_obblighi = "SELECT id_obbligation FROM dr_obbligation WHERE id_obbligation = :id_obbligation";
            $stmt_get_obblighi = $db->prepare($sql_get_obblighi);
            $stmt_get_obblighi->execute(array(':id_obbligation' => $id_obbligation));
            while ($row = $stmt_get_obblighi->fetch(PDO::FETCH_ASSOC)) {
                $obblighi_inseriti[] = $row['id_obbligation'];
            }

            // Verifica se sono stati selezionati gruppi
            if (isset($_POST["gruppi"]) && !empty($_POST["gruppi"])) {
                // Prepara l'istruzione SQL per l'inserimento delle assegnazioni
                $sql_assign_obbligo = "INSERT INTO dr_group_obbligation (group_id, obbligation_id) VALUES (:group_id, :obbligation_id)";
                $stmt_assign_obbligo = $db->prepare($sql_assign_obbligo);

                // Esegui l'istruzione SQL per l'inserimento delle assegnazioni
                foreach ($_POST["gruppi"] as $gruppo_id) {
                    foreach ($obblighi_inseriti as $obbligo_id) {
                        $stmt_assign_obbligo->execute(array(':group_id' => $gruppo_id, ':obbligation_id' => $obbligo_id));
                    }
                }
            }
        } catch (PDOException $e) {
            echo "Errore durante l'inserimento dell'obbligo: " . $e->getMessage();
        }
    } else {
        // Se l'obbligo esiste già nel database, visualizza un messaggio di errore
        echo "Un obbligo con lo stesso ID esiste già nel database";
    }
}
?>
...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="assets/img/d-solid.svg">
    <style type="text/css">
        :host,
        :root {
            --fa-font-solid: normal 900 1em/1 "Font Awesome 6 Solid";
        ...
        <ul class="navbar-nav align-items-center ms-auto">
            ...
            <li class="nav-item dropdown no-caret d-none d-md-block me-3">
                ...
                <div class="dropdown-menu dropdown-menu-end py-0 me-sm-n15 me-lg-0 o-hidden animated--fade-in-up" aria-labelledby="navbarDropdownDocs">
                    <a class="dropdown-item py-3" href="https://docs.startbootstrap.com/sb-admin-pro" target="_blank">
                        <div class="icon-stack bg-primary-soft text-primary me-4"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-book">
                    ...
                    <a class="dropdown-item py-3" href="https://docs.startbootstrap.com/sb-admin-pro/components" target="_blank">
                        <div class="icon-stack bg-primary-soft text-primary me-4"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-code">
                    ...
                    <a class="dropdown-item py-3" href="https://docs.startbootstrap.com/sb-admin-pro/changelog" target="_blank">
                        <div class="icon-stack bg-primary-soft text-primary me-4"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text">
                ...
                <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownAlerts">
                    ...
                    <a class="dropdown-item dropdown-notifications-item" href="#!">
                        <div class="dropdown-notifications-item-icon bg-danger"><svg class="svg-inline--fa fa-triangle-exclamation" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="triangle-exclamation" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                            ...
                            </svg><!-- <i class="fas fa-exclamation-triangle"></i> Font Awesome fontawesome.com --></div>
                        <div class="dropdown-notifications-item-content">
            ...
            <li class="nav-item dropdown no-caret d-none d-sm-block me-3 dropdown-notifications">
                ...
                <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownMessages">
                    ...
                    <!-- Example Message 1  -->
                    <a class="dropdown-item dropdown-notifications-item" href="#!">
                        <img class="dropdown-notifications-item-img" src="assets/img/profile-2.png">
                        <div class="dropdown-notifications-item-content">
                    ...
                    <!-- Example Message 2-->
                    <a class="dropdown-item dropdown-notifications-item" href="#!">
                        <img class="dropdown-notifications-item-img" src="assets/img/profile-3.png">
                        <div class="dropdown-notifications-item-content">
                            <div class="dropdown-notifications-item-content-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</div>
                    ...
                    <!-- Example Message 3-->
                    <a class="dropdown-item dropdown-notifications-item" href="#!">
                        <img class="dropdown-notifications-item-img" src="assets/img/profile-4.png">
                        <div class="dropdown-notifications-item-content">
                            <div class="dropdown-notifications-item-content-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</div>
                    ...
                    <!-- Example Message 4-->
                    <a class="dropdown-item dropdown-notifications-item" href="#!">
                        <img class="dropdown-notifications-item-img" src="assets/img/profile-5.png">
                        <div class="dropdown-notifications-item-content">
                            <div class="dropdown-notifications-item-content-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</div>
            ...
            <li class="nav-item dropdown no-caret dropdown-user me-3 me-lg-4">
                <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownUserImage" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="img-fluid" src="assets/img/profile-1.png"></a>
                <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownUserImage">
                    <h6 class="dropdown-header d-flex align-items-center">
                        <img class="dropdown-user-img" src="assets/img/profile-1.png">
                        <div class="dropdown-user-details">
                            <div class="dropdown-user-details-name">Leonardo Zanarella</div>
                            <div class="dropdown-user-details-email">leo.zanarella@gmail.com</div>
                        </div>
                    </h6>
            ...
            <nav class="sidenav shadow-right sidenav-light">
                <div class="sidenav-menu">
                    <div class="nav accordion" id="accordionSidenav">
                                ...
                                <div class="collapse" id="pagesCollapseAuth" data-bs-parent="#accordionSidenavPagesMenu">
                                    <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPagesAuth">
                                        ...
                                        <a class="nav-link collapsed" href="javascript:void(0);" data-bs-toggle="collapse" data-bs-target="#pagesCollapseAuthBasic" aria-expanded="false" aria-controls="pagesCollapseAuthBasic">
                                            Basic
                                            <div class="sidenav-collapse-arrow"><svg class="svg-inline--fa fa-angle-down" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-down" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
                        ...
                        <a class="nav-link" href="table_obbligation.php">
                            Obblighi<div class="sidenav-collapse-arrow"><!-- <i class="fas fa-angle-down"></i> Font Awesome fontawesome.com --></div>
                        </a>
                ...
                <div class="sidenav-footer">
                    <div class="sidenav-footer-content">
                        ...
                        <div class="sidenav-footer-title">Leonardo Zanarella</div>
                    </div>
                </div>
            </nav>
        </div>
        <div id="layoutSidenav_content">
            <main>
                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-auto mt-4">
                                    <h1 class="page-header-title">
                                        ...
                                        <!-- Visualizza il messaggio solo se il creatore è stato aggiornato con successo -->
                                        <?php if ($obbligoAggiornato) : ?>
                                            <div>Messaggio: Obbligo aggiornato</div>
                                        <?php endif; ?>
                ...
                <div class="col-xl-8" style="margin-top: 50px;">
                    ...
                    <div class="card mb-4" style="display: flex; /* Per centrare orizzontalmente */align-items: center; /* Per centrare verticalmente */flex-direction: column;flex-wrap: nowrap;align-content: center;margin-left: 300px;">
                        <div class="card-header">Obbligation Details</div>
                        <div class="card-body">
                            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                <!-- Form Group (description) -->
                                <div class="form-group">
                                    <label class="small mb-1" for="inputDescriptionObbligation">Description Obbligation</label>
                                    <input class="form-control" id="inputDescriptionObbligation" name="description_obbligation" type="text" placeholder="Enter obligation description" value="">
                                </div>
                                <!-- Form Group (date) -->
                                <div class="form-group">
                                    <label class="small mb-1" for="inputDataCreationObbligation">Data Creation Obbligation</label>
                                    <input class="form-control" id="inputDataCreationObbligation" name="data_creation_obbligation" type="date" placeholder="Enter the date of creation" value="">
                                </div>
                                <!-- Form Group (checkbox for groups) -->
                                <div class="form-group">
                                    <label>Seleziona i gruppi:</label><br>
                                    <?php
                                    // Esegui una query per ottenere tutti i gruppi dal database
                                    $sql = "SELECT * FROM dr_group";
                                    $result = $db->query($sql);

                                    // Stampare una checkbox per ogni gruppo
                                    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                        echo '<input type="checkbox" name="gruppi[]" value="' . $row['id_group'] . '"> ' . $row['name_group'] . '<br>';
                                    }
                                    ?>
                                </div>
                                <!-- Save changes button -->
                                ...
                                <!-- Aggiunta messaggio di conferma -->
                                <?php if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["save_changes"])) : ?>
                                    <?php if ($obbligoAggiornato) : ?>
                                        <div class="alert alert-success" role="alert">
                                            L'obbligo è stato assegnato ai gruppi con successo!
                                        </div>
                                    <?php else : ?>
                                        <div class="alert alert-danger" role="alert">
                                            Si è verificato un errore durante l'assegnazione dell'obbligo ai gruppi.
                                        </div>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </form>
