...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["save_changes"]) && isset($_POST['email_address']) && isset($_POST['password'])) {
    ...
    $utenteAggiornato = true;

    // Genera un ID univoco per id_user utilizzando il timestamp attuale
    $id_user = time();

    // Verifica se l'utente con lo stesso ID esiste già nel database
    $sql_check_existence = "SELECT id_user FROM dr_user WHERE id_user = $id_user";
    $stmt_check_existence = $db->query($sql_check_existence);

    if ($stmt_check_existence->rowCount() == 0) {
        // Se l'utente non esiste già nel database, esegui l'inserimento
        $sql = "INSERT INTO dr_user (id_user, email_user, date_creation_user, password_user) 
                VALUES ($id_user, '$email_user', NOW(), '$password_user')";
        ...
        // Se l'utente esiste già nel database, visualizza un messaggio di errore
        echo "Un utente con lo stesso ID esiste già nel database";
                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-auto mt-4">
                                    <h1 class="page-header-title">
                                        ...
                                        <!-- Visualizza il messaggio solo se il gruppo è stato aggiornato con successo -->
                                        <?php if ($utenteAggiornato) : ?>
                                            <div>Messaggio: Utente aggiornato</div>
                                        <?php endif; ?>
                        ...
                        <div class="card-body">
                            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                ...
                                <div class="row gx-3 mb-3">
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="inputDateCreationUser">Date Creation User</label>
                                        <input class="form-control" id="inputDateCreationUser" name="date_creation_user" type="text" placeholder="Enter Date Creation User" value="">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="inputEmailAddress">Email Address</label>
                                        <input class="form-control" id="inputEmailAddress" name="email_address" type="text" placeholder="Enter your email address" value="">
                                    </div>
                                </div>
                                ...
                                <div class="row gx-3 mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="inputPassword" name="password" type="text" placeholder="Enter your password" value="">
                                    </div>
                                </div>
