...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["save_changes"]) && isset($_POST['name']) && isset($_POST['color'])) {
    ...
    $sql_check_existence = "SELECT id_group FROM dr_group WHERE id_group = $id_group";
    ...
    if ($stmt_check_existence->rowCount() == 0) {
        ...
        $sql = "INSERT INTO dr_group (id_group, name_group, color_group, description_group) 
                VALUES ($id_group, '$name_group', '$color_group', NULL)";

        // Esegui la query
        try {
            $db->exec($sql);
            echo "Nuovo gruppo inserito con successo";

            // Rimuovi il flag per consentire l'invio del form di nuovo
            unset($_SESSION['form_submitted']);
        } catch (PDOException $e) {
            echo "Errore durante l'inserimento del gruppo: " . $e->getMessage();
        }
    } else {
        // Se il creatore esiste già nel database, visualizza un messaggio di errore
        echo "Un gruppo con lo stesso ID esiste già nel database";
                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-auto mt-4">
                                    <h1 class="page-header-title">
                                        ...
                                        <?php if ($gruppoAggiornato) : ?>
                                            <div>Messaggio: Gruppo aggiornato</div>
                                        <?php endif; ?>
                            ...
                            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="inputName" name="name" type="text" placeholder="Enter the name" value="">
                                    </div>
                                    <!-- Form Group (last name)-->
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="inputColor">Color</label>
                                        <input class="form-control" id="inputColor" name="color" type="text" placeholder="Enter the color" value="">
                                    </div>
                                </div>
                                <!-- Form Row        -->
                                <div class="row gx-3 mb-3">
