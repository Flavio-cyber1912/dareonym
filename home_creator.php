            ...
            <main>
                ...
                <div class="col-xl-8" style="margin-top: 50px;">
                    ...
                    <div class="card mb-4" style="display: flex; /* Per centrare orizzontalmente */align-items: center; /* Per centrare verticalmente */flex-direction: column;flex-wrap: nowrap;align-content: center;margin-left: 300px;">
                        <div class="card-header">Obblighi: Comprendere, Rispettare, Realizzare</div>
                        <div class="card-body">
                            <form method="post" action="/dareonym/home_creator.php">
                                <!-- Form Group (username)-->
                                ...
                                <!-- Save changes button-->
                                <a href="table_obbligation.php" class="btn btn-primary">Gestione Obblighi</a>
                            </form>
                        </div>
                    </div>
                </div>
