<?php
// Percorso della cartella sorgente delle immagini
...
if (isset($_POST["submit"])) {
    // Controlla se il file è effettivamente un'immagine
    $check = getimagesize($_FILES["fileToUpload"]["tmp_name"]);
    if ($check !== false) {
        echo "Il file è un'immagine - " . $check["mime"] . ".";
        $uploadOk = 1;
    } else {
        echo "Spiacenti, il file non è un'immagine.";
        $uploadOk = 0;
    }
    ...
    // Check se $uploadOk è impostato a 0 a causa di un errore
    if ($uploadOk == 0) {
        echo "Spiacenti, il tuo file non è stato caricato.";
    } else {
        // Prova a caricare il file se tutto è ok
...
<head>
    ...
    <title>Obblighi completati</title>
    <style type="text/css">
        :host,
        :root {
            ...
            <main>
                ...
                <nav class="navbar navbar-marketing navbar-expand-lg bg-white navbar-light">
                    <div class="container px-5">
                        <a class="navbar-brand text-primary" href="index.html">Dareonym</a>
                    ...
                    <div class="page-header-ui-content">
                        <div class="container px-5">
                            <div class="row gx-5 align-items-center">
                                <div class="col-lg-7">
                                    <h1 class="page-header-ui-title">Nome dell'Obbligo</h1>
                                    <p class="page-header-ui-text mb-5">Inserisci qui sotto l'obbligo</p>
                                    <!-- Form per caricare l'obbligo -->
                                    <form action="testimonianze.php" method="post" enctype="multipart/form-data">
