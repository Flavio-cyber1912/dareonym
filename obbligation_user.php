...
if (!isset($_SESSION["user"])) {
    header('location: obbligation_user.php');
}
            ...
            <nav class="sidenav shadow-right sidenav-light">
                <div class="sidenav-menu">
                    <div class="nav accordion" id="accordionSidenav">
                        ...
                        <a class="nav-link collapsed" href="obbligation_user.php">
                            ...
                            <div class="tab-pane fade active show" id="activities" role="tabpanel" aria-labelledby="activities-pill">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        // Query per ottenere gli obblighi dal database
                                        $sql = "SELECT id_obbligation, description_obbligation, data_creation_obbligation FROM dr_obbligation";
                                        $stmt = $db->query($sql);

                                        // Verifica se la query è stata eseguita correttamente
                                        if ($stmt === false) {
                                            die("Errore nella query: " . $db->errorInfo()[2]);
                                        } else {
                                            // Verifica se ci sono righe restituite dalla query
                                            if ($stmt->rowCount() > 0) {
                                                // Itera sui risultati e stampa i dati
                                                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                    // Accedi alle colonne specifiche
                                                    $ID = $row["id_obbligation"];
                                                    $description = $row["description_obbligation"];
                                                    $dateCreation = $row["data_creation_obbligation"];
                                                ...
                                                echo "<tr><td colspan='3'>Nessun obbligo trovato.</td></tr>";
                                            }
                                        }
