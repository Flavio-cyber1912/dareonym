                    ...
                    <div class="card-body">
                        <div class="tab-content" id="dashboardNavContent">
                            ...
                            <div class="tab-pane fade active show" id="activities" role="tabpanel" aria-labelledby="activities-pill">
                                ...
                                function updateLog($db, $id, $date_creation_log)
                                {
                                    $sql = "UPDATE dr_log SET date_creation_log=? WHERE id_log=?";
                                    $stmt = $db->prepare($sql);
                                    $stmt->execute([$date_creation_log, $id]);
                                }

                                function deleteLog($db, $id)
                                {
                                    $sql = "DELETE FROM dr_log WHERE id_log=?";
                                    $stmt = $db->prepare($sql);
                                    $stmt->execute([$id]);
                                }
                                ...
                                if (isset($_POST['update_log'])) {
                                    $id = $_POST['id'];
                                    $date_creation_log = isset($_POST['date_creation_log']) ? $_POST['date_creation_log'] : null;
                                    updateLog($db, $id, $date_creation_log);
                                }
                                ...
                                if ($result->rowCount() > 0) {
                                    ...
                                    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                        ...
                                        echo "<td>" . $row["date_creation_log"] . "</td>";
                                        echo "<td>";
                                        echo "<details>";
                                        echo "<summary>Update</summary>";
                                        echo "<form method='post' action=''>";
                                        echo "<input type='hidden' name='id' value='" . $row["id_log"] . "'>";
                                        echo "<input type='date' name='date_creation_log' value='" . $row["date_creation_log"] . "' required>"; // Corretto il tipo di input
                                        echo "<input type='submit' name='update_log' value='Update' class='btn btn-info'>";
                                        echo "</form>";
                                        echo "</details>";
                                        echo "</td>";
                                        echo "<td>";
                                        echo "<form method='post' action=''>";
                                        echo "<input type='hidden' name='id' value='" . $row["id_log"] . "'>";
                                        echo "<input type='submit' name='delete_log' value='Delete' class='btn btn-danger' onclick='return confirm(\"Sei sicuro di voler eliminare questo log?\")'>";
                                        echo "</form>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                    ...
                                    echo "<p>Nessun log trovato nel database.</p>";
                                }
                                ?>



                                <a href="creation_log.php" class="btn btn-secondary">
