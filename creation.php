...
// Variabile per indicare se il modulo è stato inviato con successo
$creatoreAggiornato = false;

// Verifica se il form è stato inviato e le variabili sono state inizializzate
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["save_changes"]) && isset($_POST['email_address']) && isset($_POST['password'])) {
    // Imposta un flag per indicare che il form è stato inviato
    $_SESSION['form_submitted'] = true;

    // Assegna i valori delle variabili
    $email_creator = $_POST['email_address'];
    $password_creator = $_POST['password'];

    // Qui puoi mettere il codice per salvare i cambiamenti nel creatore

    // Imposta la variabile $creatoreAggiornato su true per indicare che il creatore è stato aggiornato
    $creatoreAggiornato = true;

    // Genera un ID univoco per id_creator utilizzando il timestamp attuale
    $id_creator = time();

    // Verifica se il creatore con lo stesso ID esiste già nel database
    $sql_check_existence = "SELECT id_creator FROM dr_creator WHERE id_creator = $id_creator";
    $stmt_check_existence = $db->query($sql_check_existence);

    if ($stmt_check_existence->rowCount() == 0) {
        // Se il creatore non esiste già nel database, esegui l'inserimento
        $sql = "INSERT INTO dr_creator (id_creator, admin_id, email_creator, password_creator, date_creation_creator) 
                VALUES ($id_creator, NULL, '$email_creator', '$password_creator', NULL)";

        // Esegui la query
        try {
            $db->exec($sql);
            echo "Nuovo creatore inserito con successo";

            // Rimuovi il flag per consentire l'invio del form di nuovo
            unset($_SESSION['form_submitted']);
        } catch (PDOException $e) {
            echo "Errore durante l'inserimento del creatore: " . $e->getMessage();
        }
    } else {
        // Se il creatore esiste già nel database, visualizza un messaggio di errore
        echo "Un creatore con lo stesso ID esiste già nel database";
                ...
                <div class="sidenav-menu">
                    <div class="nav accordion" id="accordionSidenav">
                        ...
                        <a class="nav-link" href="creators.php">
                            Creatori<div class="sidenav-collapse-arrow"><!-- <i class="fas fa-angle-down"></i> Font Awesome fontawesome.com --></div>
                        </a>
                        <div class="collapse show" id="collapseDashboards" data-bs-parent="#accordionSidenav">

                        </div>
                        <a class="nav-link" href="groups.php">
                            Gruppi<div class="sidenav-collapse-arrow"><!-- <i class="fas fa-angle-down"></i> Font Awesome fontawesome.com --></div>
                        </a>
                        <a class="nav-link" href="users.php">
                            Utenti<div class="sidenav-collapse-arrow"><!-- <i class="fas fa-angle-down"></i> Font Awesome fontawesome.com --></div>
                        </a>

                        <!-- Sidenav Accordion (Pages)-->
                        <a class="nav-link" href="log.php">
                            Log<div class="sidenav-collapse-arrow"><!-- <i class="fas fa-angle-down"></i> Font Awesome fontawesome.com --></div>
                        </a>
                        ...
                        <a class="nav-link" href="obbligation.php">
                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-auto mt-4">
                                    <h1 class="page-header-title">
                                        ...
                                        <?php if ($creatoreAggiornato) : ?>
                                            <div>Messaggio: Creatore aggiornato</div>
                                        <?php endif; ?>
                        ...
                        <div class="card-body">
                            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="inputUsername" name="username" type="text" placeholder="Enter your username" value="">
                                </div>
                                 <!-- Form Row-->
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="inputFirstName" name="first_name" type="text" placeholder="Enter your first name" value="">
                                    </div>
                                    <!-- Form Group (last name)-->
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="inputLastName">Last name</label>
                                        <input class="form-control" id="inputLastName" name="last_name" type="text" placeholder="Enter your last name" value="">
                                    </div>
                                </div>
                                <!-- Form Row        -->
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="inputOrgName" name="email_address" type="text" placeholder="Enter your email address" value="">
                                    </div>
                                    <!-- Form Group (location)-->
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="inputLocation">Password</label>
                                        <input class="form-control" id="inputLocation" name="password" type="text" placeholder="Enter your password" value="">
                                    </div>
                                </div>
                                <!-- Save changes button-->
