                ...
                <div class="card mb-4">
                    <div class="card-header border-bottom">
                        ...
                        <ul class="nav nav-tabs card-header-tabs" id="dashboardNav" role="tablist">
                            <li class="nav-item"><a class="nav-link active" id="activities-pill" href="#activities" data-bs-toggle="tab" role="tab" aria-controls="activities" aria-selected="true">Users</a></li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <div class="tab-content" id="dashboardNavContent">
                            ...
                            <div class="tab-pane fade active show" id="activities" role="tabpanel" aria-labelledby="activities-pill">
                                ...
                                function updateUser($db, $id, $email, $date_creation, $password)
                                {
                                    $sql = "UPDATE dr_user SET email_user=?, date_creation_user=?, password_user=? WHERE id_user=?";
                                    $stmt = $db->prepare($sql);
                                    $stmt->execute([$email, $date_creation, $password, $id]);
                                }

                                // Funzione per l'eliminazione dell'utente
                                function deleteUser($db, $id)
                                {
                                    $sql = "DELETE FROM dr_user WHERE id_user=?";
                                    $stmt = $db->prepare($sql);
                                    $stmt->execute([$id]);
                                }
                                ...
                                if (isset($_POST['update_user'])) {
                                    ...
                                    updateUser($db, $id, $email, $date_creation, $password);
                                }

                                // Verifica se è stata inviata una richiesta per eliminare l'utente
                                if (isset($_POST['delete_user'])) {
                                    $id = $_POST['id'];

                                    deleteUser($db, $id);
                                }
                                // Query per ottenere i dati degli utenti dalla tabella 'dr_user'
                                $sql = "SELECT * FROM dr_user";
                                $result = $db->query($sql);

                                // Verifica se sono presenti risultati
                                if ($result->rowCount() > 0) {
                                    // Output dei dati degli utenti in una tabella
                                    echo "<table class='table'>";
                                    echo "<thead>";
                                    echo "<tr>";
                                    echo "<th>ID</th>";
                                    echo "<th>Email</th>";
                                    echo "<th>Data di Creazione</th>";
                                    echo "<th>Password</th>";
                                    echo "<th>Update</th>";
                                    echo "<th>Delete</th>";
                                    echo "</tr>";
                                    ...
                                    while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                        ...
                                        echo "<input type='email' name='email' value='" . $row["email_user"] . "' required>";
                                        echo "<input type='date' name='date_creation' value='" . $row["date_creation_user"] . "' required>";
                                        echo "<input type='password' name='password' value='" . $row["password_user"] . "' required>";
                                        echo "<input type='submit' name='update_user' value='Update' class='btn btn-info'>";
                                        echo "</form>";
                                        echo "</details>";
                                        echo "</td>";

                                        // Form per l'eliminazione dell'utente
                                        echo "<td>";
                                        echo "<form method='post' action=''>";
                                        echo "<input type='hidden' name='id' value='" . $row["id_user"] . "'>";
                                        echo "<input type='submit' name='delete_user' value='Delete' class='btn btn-danger' onclick='return confirm(\"Sei sicuro di voler eliminare questo utente?\")'>";
                                        echo "</form>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                ...
                                <a href="creation_users.php" class="btn btn-warning">
