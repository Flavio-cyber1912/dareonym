...
if (isset($_POST["username"])) {
    ...
    try {
        ...
        $sth = $db->prepare("SELECT * FROM dr_user WHERE email_user = ? AND password_user = ?");
        $sth->execute(array(
            $email,
            $password
        ));
    ...
    <div id="layoutDefault">
        <div id="layoutDefault_content">
            <main>
                ...
                <!-- Page Header-->
                <header class="page-header-ui page-header-ui-dark bg-img-repeat bg-secondary" style="background-image: url('assets/img/backgrounds/pattern-shapes.png')">
                    <div class="page-header-ui-content">
                        <div class="container px-5">
                            <div class="row gx-5 align-items-center">
                                <div class="col-lg-6">

                                    <h1 class="page-header-ui-title" style="color: white;margin-top: 50px;">Dareonym</h1>

                                </div>
                                <div class="col-lg-6">
                                    <div class="card rounded-3 text-dark" style=" margin-top: 100px;">
