...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["save_changes"]) && isset($_POST['date_creation_log'])) {
    // Imposta un flag per indicare che il form è stato inviato
    $_SESSION['form_submitted'] = true;

    // Assegna i valori delle variabili
    $date_creation_log = $_POST['date_creation_log'];
    ...
    $sql_check_existence = "SELECT id_log FROM dr_log WHERE id_log = $id_log";
    ...
    if ($stmt_check_existence->rowCount() == 0) {
        ...
        $sql = "INSERT INTO dr_log (id_log, date_creation_log, description_log) 
                VALUES ($id_log, '$date_creation_log', NULL)";

        // Esegui la query
        try {
            $db->exec($sql);
            echo "Nuovo log inserito con successo";

            // Rimuovi il flag per consentire l'invio del form di nuovo
            unset($_SESSION['form_submitted']);
        } catch (PDOException $e) {
            echo "Errore durante l'inserimento del log: " . $e->getMessage();
        }
    } else {
        // Se il log esiste già nel database, visualizza un messaggio di errore
        echo "Un log con lo stesso ID esiste già nel database";
            ...
            <nav class="sidenav shadow-right sidenav-light">
                <div class="sidenav-menu">
                    <div class="nav accordion" id="accordionSidenav">
                        ...
                        <div class="collapse show" id="collapseApps" data-bs-parent="#accordionSidenav">
                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-auto mt-4">
                                    <h1 class="page-header-title">
                                        ...
                                        <?php if ($logAggiornato) : ?>
                                            <div>Messaggio: log aggiornato</div>
                                        <?php endif; ?>
                        ...
                        <div class="card-body">
                            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="inputDateCreationLog">Date Creation Log</label>
                                        <input class="form-control" id="inputDateCreationLog" name="date_creation_log" type="text" placeholder="Enter the date of creation" value="" style="width: 300px;">
                                    </div>
                                </div>
                                <!-- Form Row        -->
                                <div class="row gx-3 mb-3">
