                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-auto mt-4">
                                    <h1 class="page-header-title">
                                        ...
                                        Benvenuto, leo.zanarella@gmail.com!;
                                    </h1>
                ...
                <div class="container-xl px-4 mt-n10">
                    <div class="row">
                        <div class="col-xl-4 mb-4">
                            ...
                            <a class="card lift h-100" href="users.php">
                                <div class="card-body d-flex justify-content-center flex-column">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <img src="assets/img/browser-stats.svg" alt="..." style="width: 8rem">
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-xl-4 mb-4">
                            ...
                            <a class="card lift h-100" href="groups.php">
                                <div class="card-body d-flex justify-content-center flex-column">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="me-3">
                                        ...
                                        <img src="assets/img/processing.svg" alt="..." style="width: 8rem">
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-xl-4 mb-4">
                            ...
                            <a class="card lift h-100" href="ranking.php">
                                <div class="card-body d-flex justify-content-center flex-column">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="me-3">
                                            ...
                                            <h5> Classifica</h5>
                                            <div class="text-muted small">Visualizza la classifica settimanale degli obblighi completati dagli utenti</div>
                                        </div>
                                        <img src="assets/img/windows.svg" alt="..." style="width: 8rem">
                                    </div>
                                </div>
                            </a>
                        </div>
